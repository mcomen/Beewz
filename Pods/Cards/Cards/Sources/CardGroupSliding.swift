...
@IBDesignable open class CardGroupSliding: CardGroup {
     ...
     */
    @IBInspectable public var iconsSize: CGFloat = 60
    /**
     Corner radius of the collection view items
     */
    @IBInspectable public var iconsRadius: CGFloat = 0
    ...
    override  func initialize() {
        ...
        backgroundIV.backgroundColor = UIColor.clear
    ...
    @objc private func slide(){
        ...
        if __CGPointEqualToPoint(startPoint, slidingCV.contentOffset) {
            ...
            if w<slidingCV.contentSize.width { w+=0.2 }
...
extension CardGroupSliding: UICollectionViewDelegateFlowLayout{
    ...
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        iconsSize = collectionView.frame.height/5 - layout.minimumLineSpacing
