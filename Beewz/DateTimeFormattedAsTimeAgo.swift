...
func minutesFormatter(_ minutes: Int) -> String {
    return classicFormatterAgo(minutes, unit: "min")
}

func hoursFormatter(_ hours: Int) -> String {
    return classicFormatterAgo(hours, unit: "ho")
}
...
func weeksFormatter(_ weeks: Int) -> String {
    return classicFormatterAgo(weeks, unit: "w")
}

func monthsFormatter(_ months: Int) -> String {
    return classicFormatterAgo(months, unit: "mon")
}
